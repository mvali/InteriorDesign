...
public static class CultureHelper
{
    ...
    public static bool LanguageIs(string name)
    {
        var retV = false;
        string routeLanguage = GetCurrentLanguage();
        if (name.Equals(routeLanguage, StringComparison.InvariantCultureIgnoreCase))
            retV = true;
        return retV;
    }
}
